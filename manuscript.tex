...
The most striking effect of misalignment in SMCs was disruption of proteostasis gene expression. Multiple chaperone genes --- including \textit{Hspa1a}, \textit{Hspa1b}, \textit{Dnajb1}, \textit{Dnajb4}, \textit{Dnaja1}, and \textit{Hsph1} --- were substantially downregulated, particularly at ZT0 (\highlight{Figure 4e}). Beyond their roles in heat shock response, these chaperones are implicated in endoplasmic reticulum (ER) stress and the unfolded protein response. Consistent with disrupted proteostasis, \textit{Xbp1}, a key regulator of the unfolded protein response implicated in preventing neointimal hyperplasia~\cite{ref105}, was downregulated at ZT0, while \textit{Ankrd1}, which protects cells from ER stress~\cite{ref106}, was downregulated during the light phase (\highlight{Figure 4e}). \textit{Paip2b}, which inhibits mRNA translation~\cite{ref107}, was downregulated at all time points, potentially contributing to the accumulation of unfolded proteins. Conversely, \textit{Uba52}, which targets proteins for degradation~\cite{ref108,ref109}, was strongly upregulated (\highlight{Figure 4e}), and gene sets involved in transcription and ribosome biogenesis showed decreased mesors --- possibly reflecting compensatory efforts to reduce the unfolded protein burden. \textit{Atf3}, which has been described to inhibit SMC phenotypic switching, was substantially decreased at ZT0 with an acrophase delay of approximately 7 hours (\highlight{Figure 4e}), suggesting acute misalignment may additionally predispose SMCs to phenotypic switching.

Beyond desynchrony between the central and peripheral clocks, misalignment also appeared to alter the intracellular timing relationships among clock genes within SMCs. Restricting to clock genes whose posterior acrophase 95\% interval was within 2 hours in both conditions, we found that \textit{Dbp} and \textit{Nr1d1} --- both direct transcriptional targets of BMAL1:CLOCK --- compressed their phase delay relative to \textit{Arntl} by approximately 1.3 and 1.2 hours, respectively (\highlight{Figure 4d}). This suggests that even within individual cell types, the internal architecture of the clock may be rearranged during acute misalignment.

Acute misalignment also appeared to alter macrophage recruitment timing. While most shared cycling genes shifted acrophases toward the new LD cycle, macrophage \textit{Ccr2} and \textit{Cx3cr1} --- which mediate rhythmic macrophage recruitment to the vasculature~\cite{ref4,ref89,ref90,ref91} --- showed acrophase delays of approximately 6 hours, suggesting minimal adaptation (\highlight{Figure 4c}). However, macrophage estimates should be interpreted cautiously given the low cell counts and shallow sequencing depth in this population. Female-specific misalignment effects are presented in the Supplementary Results.
