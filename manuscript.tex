...
\textbf{a)} Experimental conditions: male and female C57BL/6 mice under aligned and misaligned light-dark cycles, and male and female \textit{Bmal1}$^{\text{fl/fl}}$:CAGG$^{\text{creERt2/+}}$ mice under aligned conditions. Mice were sacrificed at ZT0, ZT6, ZT12, and ZT18, whole aortas were dissected and dissociated, and single-cell RNA-sequencing was performed.
\textbf{b)} Light-dark cycle and sample collection protocol for aligned mice.
\textbf{c)} Light-dark cycle and sample collection protocol for misaligned mice, subjected to a 6-hour phase advance 5 days prior to sacrifice.
...
\textbf{a)} Number of daily cycling genes shared between males and females in each major cell type, requiring acrophases within 3 hours.
\textbf{b)} Reactome pathway enrichment among daily cyclers in SMCs (left) and fibroblasts (right). Rose plots show enriched gene sets positioned by the mean acrophase of their member genes; radial extent indicates the number of member genes.
\textbf{c)} Transcription factor motif enrichment among daily cyclers in SMCs (left) and fibroblasts (right), plotted as in (b).
\textbf{d)} Acrophase distributions of SMC daily cyclers implicated in phenotypic switching. Left: genes that monotonically increase during the SMC-to-SEM transition. Right: genes that monotonically decrease. Red lines indicate expected counts under a uniform distribution; $n$ and $p$-values from enrichment tests for dusk (left) or dawn (right) peak times.

\textbf{Figure 3: Enhanced rhythmicity of female aortic cell types.}
\textbf{a)} Distribution of the fraction of posterior amplitude samples larger in females than males, for genes cycling in either sex. Dashed line indicates 0.5 (no difference); median shown. Distributions shifted right indicate higher female amplitudes.
\textbf{b)} Number of circadian cycling genes in males and females across $\log_{10}$ Bayes factor thresholds, after downsampling cells and pseudobulk UMI counts to match between sexes. SMCs (left) and fibroblasts (right).
\textbf{c)} Sex-differential waveform enrichment analysis. Difference waveforms (female $-$ male) for KEGG pathway gene sets (top) and transcription factor motif gene sets (bottom) in SMCs (left) and fibroblasts (right). Each line represents a gene set; values above zero indicate higher expression in females at that time point.

\textbf{Figure 4: Circadian misalignment disrupts proteostasis and cell-type entrainment in the aorta.}
\textbf{a)} Distribution of the fraction of posterior amplitude samples larger in misaligned than aligned mice, for genes cycling in either condition. Distributions shifted left of 0.5 indicate reduced amplitudes after misalignment.
\textbf{b)} Acrophase scatter plots comparing aligned (x-axis) and misaligned (y-axis) peak times for cycling genes shared between conditions. Dashed line indicates identity (perfect entrainment); points above the line indicate delayed acrophases. $n$, number of shared cycling genes.
\textbf{c)} Posterior distributions of the phase delay between \textit{Dbp} and \textit{Arntl} (left) and \textit{Nr1d1} and \textit{Arntl} (right) in SMCs, comparing aligned and misaligned conditions. Compression of the delay indicates altered intracellular clock architecture.
\textbf{d)} Posterior waveforms of macrophage \textit{Ccr2} (left) and \textit{Cx3cr1} (right) in aligned and misaligned conditions. Violin plots show posterior $\log_{10}$ transcript proportion estimates at each time point; horizontal lines indicate posterior means.
\textbf{e)} KEGG pathway waveform enrichment showing the difference in $\log_{10}$ expression rate (misaligned $-$ aligned) at each time point for SMCs (left) and fibroblasts (right). Values below zero indicate decreased expression after misalignment.
\textbf{f)} Posterior waveforms of representative proteostasis-related genes in SMCs, comparing aligned and misaligned conditions. Violin plots as in (d).
...
At 8 weeks of age, \textit{Bmal1} was inducibly deleted in \textit{Bmal1}$^{\text{fl/fl}}$:CAGG$^{\text{creERt2/+}}$ mice by administering tamoxifen via oral gavage (100 mg/kg of body weight) for 5 days. Confirmation of \textit{Bmal1} protein expression loss was confirmed via Western blot (\highlight{Supplementary Figure 5}).
