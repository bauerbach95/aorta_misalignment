...
Acute misalignment also appeared to alter macrophage recruitment timing. While most shared cycling genes shifted acrophases toward the new LD cycle, macrophage \textit{Ccr2} and \textit{Cx3cr1} --- which mediate rhythmic macrophage recruitment to the vasculature~\cite{ref4,ref89,ref90,ref91} --- showed acrophase delays of approximately 6 hours, indicating minimal adaptation (\highlight{Figure 4c}). To assess whether this reflected a general property of macrophage clocks, we compared core clock gene entrainment across cell types. For clock genes confidently cycling in all cell types of both aligned and misaligned mice, we estimated the posterior distribution of the acrophase delay in the misaligned condition. Macrophages consistently showed the most posterior density near 6 hours (no shift), even compared to ECs with comparable cell counts (\highlight{Figure 4d}). This suggests macrophage clocks may entrain more slowly than the endogenous vascular cell types, potentially disrupting the relative circadian timing between cell types during acute misalignment. Female-specific misalignment effects are presented in the Supplementary Results.
