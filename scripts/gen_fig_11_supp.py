"""
Generate Supplementary Figure 11: Bmal1 KO cycling controlled for sequencing depth,
...
Output:
  figures/fig_11_supp.pdf
  figures/fig_11_supp_source_data/
"""
...
SOURCE_DATA_DIR = os.path.join(FIGURES_DIR, "fig_11_supp_source_data")
...
outpath = os.path.join(FIGURES_DIR, "fig_11_supp.pdf")
