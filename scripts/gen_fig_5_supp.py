"""
Generate Supplementary Figure 5: Misalignment cycling controlled for cell
counts and library sizes.

Subplots:
  a) 2x2 grid: cycler counts vs log10 BF threshold for 4 major cell types
  b) 1x3 grid: cycler counts vs log10 BF threshold for 3 SMC subtypes

Output:
  figures/fig_5_supp.pdf
  figures/fig_5_supp_source_data/
"""
...
SOURCE_DATA_DIR = os.path.join(FIGURES_DIR, "fig_5_supp_source_data")
...
COND_AL = "male aligned bmal1-control"
COND_MIS = "male misaligned bmal1-control"
...
print("Step 1: Computing cycler counts across BF thresholds...")
...
outpath = os.path.join(FIGURES_DIR, "fig_5_supp.pdf")
