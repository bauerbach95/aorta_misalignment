"""
Supplementary figure: Male-specific circadian cyclers in mouse aortic cell types.

Analogous to Figure 2 but for male-only cyclers (not shared M/F).

Subplots:
  a) Bar chart: number of male cyclers per major cell type
...
Output:
  figures/section_2_supp_male_cyclers.pdf
  figures/section_2_supp_male_cyclers_source_data/
"""
...
SEX = "male"
FIGURE_NAME = "section_2_supp_male_cyclers"
