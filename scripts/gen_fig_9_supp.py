"""
Generate Supplementary Figure 9: Gene-set waveform enrichment (Misaligned vs Aligned, female).

Female counterpart to Supplementary Figure 6 (male).

Two-group waveform enrichment analysis showing which pathways/TFs are
differentially expressed at each ZT timepoint under misalignment in females,
plus proteostasis gene waveforms.
...
Output:
  figures/fig_9_supp.pdf
  figures/fig_9_supp_source_data/
"""
...
SOURCE_DATA_DIR = os.path.join(FIGURES_DIR, "fig_9_supp_source_data")
ZT_HOURS = [0, 6, 12, 18]
SEX = "female"
...
# ── Step 2: Two-group waveform enrichment (misaligned vs aligned, female) ────
...
print("\nStep 4: Loading supplementary proteostasis gene waveforms (female)...")
...
# ── Row c: supplementary proteostasis gene waveforms ──────────────────────
...
outpath = os.path.join(FIGURES_DIR, "fig_9_supp.pdf")
