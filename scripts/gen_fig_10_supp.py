"""
Generate Supplementary Figure 10: iKO validation.
...
Output:
  figures/fig_10_supp.pdf
  figures/fig_10_supp_source_data/
"""
...
SOURCE_DATA_DIR = os.path.join(FIGURES_DIR, "fig_10_supp_source_data")
...
outpath = os.path.join(FIGURES_DIR, "fig_10_supp.pdf")
